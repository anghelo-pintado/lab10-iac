...
const httpRequestDuration = new client.Histogram({
  ...
  help: "Duration de las peticiones HTTP en segundos",
  labelNames: ["method", "route", "status"],
...
// meddileware: registra peticiones y alimenta las metricas
...
// Receptor del webhook de Grafana Alerting
...
const scenarios = [
  () =>
    log("INFO", "pedido_creado", {
      order_id: rand(1000, 9999),
      amount: rand(10, 500),
    }),
  () =>
    log("INFO", "pago_procesado", {
      order_id: rand(1000, 9999),
      gateway: "stripe",
    }),
  ...
  () =>
    log("WARN", "reintento_de_pago", {
      order_id: rand(1000, 9999),
      attempt: rand(2, 4),
    }),
  () =>
    log("ERROR", "fallo_conexion_inventario", {
      service: "inventory",
      code: 503,
    }),
  () =>
    log("ERROR", "excepcion_no_controlada", {
      trace_id: hex(8),
